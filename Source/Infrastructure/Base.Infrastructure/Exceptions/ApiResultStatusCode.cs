...
/// <summary>
/// برای مدیریت بهتر متن های خطا آنها را در این قالب نگهداری میکنیم
/// </summary>
public enum ApiResultStatusCode
{
    ...
    /// نمونه ای وجود ندارد
    /// </summary
    [Display(Name = "نمونه ای وجود ندارد")]
    ...
    [Display(Name = "احراز هویت شبکه مورد نیاز است")]
    Unauthorized = 401,
    //
    // Summary:
    ...
    [Display(Name = "درخواست از سمت کاربر لغو شد")]
    Gone = 410,
    //
    // Summary:
