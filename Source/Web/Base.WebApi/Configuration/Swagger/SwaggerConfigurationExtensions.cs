    ...
    public static void AddSwagger(this IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            options.SwaggerDoc("v2", new OpenApiInfo { Version = "v2", Title = "CCMSAPI V2" });
                ...
                options.OperationFilter<UnauthorizedResponsesOperationFilter>(true, JwtBearerDefaults.AuthenticationScheme);
                #endregion
                ...
                options.AddSecurityDefinition(JwtBearerDefaults.AuthenticationScheme, new OpenApiSecurityScheme
            {
                ...
                //        {
                //            TokenUrl = new Uri("/api/v2/users/Token", UriKind.Relative),
